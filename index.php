...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a id="VMA" class="navbar-brand" href="#"> <i class="fas fa-praying-hands mr-3"></i>VMA</a>
...
<main class="container">
    ...
    <section class="row">
        <div class="difference col-6 pr-0">
            <div>
                <h1 id="true-lover">The time is now. <br> Start making a difference.</span></h1>
                <a class="btn btn-dark our-places-link" href="includes/volunteerplaces.php" role="button"><span
                            class="disappear">Go to</span>
                    Our Volunteer Opportunities</a>
            </div>
        </div>
