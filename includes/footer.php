...
<body>
    <footer class="p-5 h-75 bg-dark text-white text-center position-relative">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <p>03-680-6080</p> <br>
                    <a href="mailto:ROI@managment.com">ROI@managment.com</a><br>
                    <br>
                </div>
                <div class="col-md">
                    <h2 class="headers_footer">Visit Us</h2>
                    <p>Rabenu Yeruham St 2, Tel Aviv-Yafo <br> Mon 10 am - 3 pm <br> Wed - Fri 12 pm - 7 pm <br> Sat - Sun 10 am - 3 pm <br>
                    </p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <p class="copyright"><br>ROI 2022, All Rights Reserved &copy;</p>
            </div>
        </div>
    </footer>
